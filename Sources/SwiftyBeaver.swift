...
open class SwiftyBeaver {
    ...
    class func dispatch_send(level: SwiftyBeaver.Level, message: Any? = nil,
        ...
        for dest in destinations {
            ...
            resolvedMessage = resolvedMessage == nil && dest.hasMessageFilters() ? "\(String(describing: message))" : resolvedMessage
            if dest.shouldLevelBeLogged(level, path: file, function: function, message: resolvedMessage) {
                // try to convert msg object to String and put it on queue
                let msgStr = resolvedMessage == nil ? "\(String(describing: message))" : resolvedMessage!
